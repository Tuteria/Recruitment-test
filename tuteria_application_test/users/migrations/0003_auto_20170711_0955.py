# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-07-11 08:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='booking',
            name='status',
            field=models.CharField(choices=[('cancelled', 'cancelled'), ('completed', 'completed'), ('scheduled', 'scheduled'), ('not_started', 'not_started')], default='not_started', max_length=256),
        ),
